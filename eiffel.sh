...
linuxkit build --no-sbom --name bootstrap --format kernel+initrd ./bootstrap-layout.yml
linuxkit build --no-sbom --name customer --format kernel+initrd /workspace/layout.yml
